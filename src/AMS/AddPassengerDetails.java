...
public class AddPassengerDetails extends JFrame implements ActionListener
{
    ...
    AddPassengerDetails()
    {
        ...
        ImageIcon ing=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/36.jpg"));
        Image img=ing.getImage().getScaledInstance(900, 700, Image.SCALE_SMOOTH);
    ...
    public void actionPerformed(ActionEvent e)
    {
         if(e.getSource()==bt1)
        {
            ...
            try
            {
                 ...
                 String q="insert into passenger values ('"+username+"','"+pass+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+nationality+"','"+gender+"','"+passport+"')";
