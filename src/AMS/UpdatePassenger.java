...
public class UpdatePassenger extends JFrame implements ActionListener
{
    ...
    UpdatePassenger()
    {
        ...
        ImageIcon ing=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/37.png"));
        Image img=ing.getImage().getScaledInstance( 300, 500, Image.SCALE_SMOOTH);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            {
                 ConnectionClass obj=new ConnectionClass();
                 String q="update passenger set name='"+name+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',nationality='"+nationality+"',gender='"+gender+"',passport='"+passport+"'where username='"+username+"'";
